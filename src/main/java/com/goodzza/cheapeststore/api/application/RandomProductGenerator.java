...
@Component
public class RandomProductGenerator implements RandomGenerator<ProductVo> {

    private static final List<Pair<String, String>> MOCK_PRODUCTS = ImmutableList.of(
            Pair.of("피망",
    ...
    public ProductVo generate() {
        Pair<String, String> randomMartProduct = MOCK_PRODUCTS.get(RAND.nextInt(MOCK_PRODUCTS.size()));
